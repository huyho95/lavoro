...
@section('content')
    ...
    <div class="table-responsive">
                        <h2>Quản lý sản phẩm :
                            <a href="?type=inventory" class="{{ Request::get('type') == 'inventory' || !Request::get('type') ? 'active' : '' }}">Hàng tồn </a> - <a href="?type=pay" class="{{ Request::get('type') == 'pay' ? 'active' : '' }}">Bán chạy</a>
                        </h2>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ul style='padding-left: 15px'>
                                                <li><span style="..."><i class="fas fa-dollar-sign" style="..."></i><span></span> {{ number_format($product->pro_price,0, ',', '.') }} (đ)</span></li>
                                                <li><span style="..."><i class="fas fa-dollar-sign" style="..."></i><span></span> {{ $product->pro_sale }} (%)</span></li>
                                        ...
                                        <td>
                                            <a class="btn_customer_action" style="border: 1px solid #999;padding: 5px 6px;border-radius: 5px;font-weight: bold;font-size: 12px;" href="{{ route('admin.get.edit.product',$product->id) }}"><i class="fas fa-pen" style="font-size: 11px"></i> Cập nhật</a>
                                            <a class="btn_customer_action" style="border: 1px solid #999;padding: 5px 6px;border-radius: 5px;font-weight: bold;font-size: 12px;" href="{{ route('admin.get.action.product',['delete',$product->id]) }}"><i class="fas fa-trash-alt" style="font-size: 11px"></i> Xóa</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                @endif
