					...
					<div class="col-md-5 col-sm-5 col-xs-12">
						<div class="zoomWrapper">
							<div id="img-1" class="zoomWrapper single-zoom">
								<a href="#">
									<div class="zoomWrapper"><img  style="width: 320px; height: 320px" src="{{ asset(pare_url_file($productDetail->pro_avatar)) }}"></div>
								</a>
							</div>
						</div>
					</div>
					...
					<div class="single-product-tab">
						...
						<div class="tab-content">
							...
							<div class="components_rating" style="margin-bottom: 20px">
								...
								<div class="components_rating_content" style="display: flex;align-items: center;border: 1px solid #dedede;border-radius: 5px">
									<div class="rating_item" style="width: 20%;position: relative">
										<span class="fa fa-star" style="font-size: 100px;display: block;color: #ff9750;margin: 0 auto;text-align: center"></span><b style="position: absolute;top: 50%;left: 50%;transform: translateX(-50%) translateY(-50%);color: white;font-size: 20px">{{ $ageDetail }}</b>
									</div>
...
?>
										<div class="item_rating" style="display: flex;align-items: center">
												<div style="width: 10%;font-size: 14px" class="item_rating">
